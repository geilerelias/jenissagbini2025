    ...
    <auth-layout title="Verificación de Email ">
        <AuthenticationCard>
            ...
            <div class="mb-4 text-sm text-gray-600">
                ...
                electrónico haciendo clic en el enlace que le acabamos de
                enviar? Si no recibiste el correo electrónico, con gusto te
                enviaremos otro.
            </div>
            ...
            >
                ...
                correo electrónico que proporcionó en la configuración de su
                perfil.
            </div>
