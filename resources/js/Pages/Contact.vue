...
<template>
    <PageLayout title="Contacto">
                ...
                <v-row>
                    <v-col cols="12" class="text-center">
                        ...
                        >
                            ...
                            >
                                Comparte tu proyecto o idea. Te acompañaré en tu proceso de crecimiento.
                            </p>
                        </div>
                    </v-col>
                </v-row>
                ...
                <v-row class="justify-center mt-8">
                    ...
                    >
                        ...
                        >
                            ...
                            <h3 class="text-h6 font-weight-bold text-dark mb-2">{{ card.title }}</h3>
                            <p class="text-body-2 text-muted mb-4">{{ card.description }}</p>
                            <a
                                :href="card.href"
                ...
                <v-row align="center" justify="space-between">
                    <v-col class="v-col-md-5 v-col-12">
                        <div class="d-flex align-center mb-5">
                            ...
                            <h6 class="text-subtitle-1 text-white font-weight-bold">Podemos ayudar</h6>
                        </div>
                        <h2 class="text-h4 py-4 text-white font-weight-bold">
                            Hablemos sobre cómo puedo ayudarte a impulsar tu proyecto, formación o emprendimiento.
                        </h2>
                        <v-row>
                            <v-col class="v-col-12">
                                <h6 class="text-body-1 text-white" style="opacity: 0.85">Email</h6>
                                <a
                                    class="text-decoration-none d-flex align-center mt-2"
                                    :href="`mailto:${CONTACT_INFO.email}`"
                                >
                                    <v-icon color="white" class="mr-2">mdi-email</v-icon>
                                    <span class="font-weight-medium text-white">{{ CONTACT_INFO.email }}</span>
                                </a>
                            </v-col>
                            <v-col class="v-col-12">
                                <h6 class="text-body-1 text-white" style="opacity: 0.85">Ubicación</h6>
                                <a
                                    class="text-decoration-none d-flex align-center mt-2"
                            ...
                            <v-col class="v-col-12">
                                <h6 class="text-body-1 text-white" style="opacity: 0.85">Horario</h6>
                                <p class="text-white mt-2 mb-0">{{ CONTACT_INFO.schedule }}</p>
                            </v-col>
                        </v-row>
                    </v-col>

                    <v-col class="v-col-md-5 v-col-12">
                        <v-card id="contact_form" class="elevation-0 rounded-md" variant="elevated">
                            <div class="pa-md-8 pa-6">
                                <h4 class="text-h5 font-weight-bold text-dark mb-6">
                                    Comparte tu proyecto o idea
                                </h4>
                                <v-form ref="formRef" @submit.prevent="enviarFormulario">
                                    <v-row>
                                        <v-col cols="12" sm="6">
                                            <v-text-field
        ...
        <section class="py-md-12 py-8 bg-grey-lighten-3">
            <v-container>
                <div id="map_marker" :data-aos="mobile ? 'fade-up' : 'zoom-in'" data-aos-duration="1000">
            ...
            <v-container>
                <v-row justify="center">
                    <v-col cols="12" md="8" class="text-center">
                        <v-icon size="40" color="grey" class="mb-4">mdi-lightbulb-on-outline</v-icon>
                        <blockquote class="text-h6 font-italic text-dark">
                            "La manera más rápida de mejorar cualquier habilidad es combinar un entrenamiento físico constante con un entrenamiento mental constante."
                        </blockquote>
                        <p class="text-muted mt-4">Cada reto es una oportunidad para innovar y crecer.</p>
                    </v-col>
                </v-row>
            </v-container>
        </section>
